...
void textview(int win, int w, int h, int xskip, const char *p, int tab, int lang);
const char *lineview(int win, int w, int y, int xskip, const unsigned char *p, int tab, int lang);
...
void textview(int win, int w, int h, int xskip, const char *p, int tab, int lang) {
  ...
  for (i = 0; i < h; i++) {
    p = lineview(win, w, i * 16 + 29, xskip, (const unsigned char *)p, tab, lang);
  }
